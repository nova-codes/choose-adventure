const plot = [{
  ...
  },
  {
      ...
      content: "As you walk over to the table with the winning team, you hope that with your 'help' on their win, you’d be welcomed...you feel a tug on your shirt as you walk past a lone person and hear a voice say, 'you don’t want to go sit with them. Sit...join me, there’s no point in going where you’re not wanted. It’s been a tough day and I could use a friend too.'The mysterious new kid introduces themself as Ezra and as you both chat and laugh you feel your anxiety melt away as time seems to slip away and before you know it, you hear someone shout, time for the swim! Everyone get your bathing suits and head to the lake! \n Ezra turns to you and says, 'what do you want to do?'",
      choices: [
          {
  ...
  },
  {
    ...
    content: "Upon arriving at the lake,the campers are swimming, so you and Ezra decide to jump into the lake and both swim out, away from the other kids. Ezra asks 'You know I noticed how the others treat you. Why do you let them pick on you like that? They clearly are bullies and you deserve some pay back wouldn’t you agree?'",
    choices: [
        {
            text: "Yes",
            target: 9,
  ...
  },
  {
    id: 9,
    title: "Chapter 4 || Yes ",
    content: "Ezra says, 'watch this!' Diving under the water, they disappear from sight and next thing you know kids from the middle of the lake start disappearing under the water one by one, each time, Ezra popping up screaming in a horrific high pitch noise. You laugh as they all swim away and head towards shore. The counselor says 'not funny, Ezra!' Blowing a whistle calls everyone back to shore and cancels the activity.",
    choices: [
        {
  ...
  },
  {
    ...
    content: "You scream as loud as you can and all the kids down below in the lake look up at you and move out of the way as the boulder comes careening down the hill. 'Why’d you do that?!' Ezra angrily asks. You respond, 'You can’t hurt people just cause they hurt me.' You then run down to the lake and a young man you know as Artie approaches, thanking you for watching out for him and his friends. He then adds, 'we should get to the campfire, you can sit with us.’ You feel eyes staring at you as Ezra glares at you from afar. Ezra looks at you and says, 'we should get to the campfire before we get into more trouble.'",
    choices: [
      {
        text: "Head to Campfire",
        target: 14,
  ...
  },
  {
    ...
    content: "You and Ezra arrive at the bonfire after the other campers have already found spots close to the fire. You share a spot on a log on the edge of the group and decide to listen to the end of the last spooky story. '... and they never saw them again'  (faded in the distance). ",
    choices: [
      {
  ...
  },
  {
    ...
    content: "Once You and Ezra arrive back at your cabin, you notice there is another camper’s bags on the bunk next to yours. 'Hey, looks like we’re bunkmates now' Ezra says through a grin…. 'My parents dropped me off late and this was the last bunk that was available for me. Guess you’re stuck with me for a few days'.",
    choices: [
      {
        text: "Next Day...",
        target: 18,
  ...
  },
  {
    ...
    content: "You get back to your cabin, heart pounding out of your chest. You lay down on your bunk to try to wrap your mind around everything Ezra told you. 'This can’t be real… Can it?'.... as you drift off to sleep",
    choices: [
      {
        text: "Continue...",
        target: 23
  ...
  },
  {
    ...
    content: "Once you get back to your cabin, you notice the chessboard is cleaned up, the cabin is tidy, and Artie and Ezra are nowhere to be found. 'Dammit,' you think to yourself 'now is not the time to go missing, Ezra'.",
    choices: [
      {
  ...
  },
  {
    ...
    content: "You head for the door to start looking for Artie and Ezra and stop. 'No, you know what - Ezra can deal with this on his own. I need to stay safe' You begin grabbing your things from the cabin and pack them into your duffle bag. From afar, you hear a horn blaring.",
    choices: [
      {
  ...
  },
  {
    ...
    content: "As you follow the horn sound of the horn, you realize it’s coming from the bus at the main drop off area. You walk up to the bus and see that it’s running, but the driver doesn’t seem to be in it. The doors are wide open and there is a brick sitting on the steering wheel - firing the horn.",
    choices: [
      {
        text: "Go in the Bus",
        target: 35,
  ...
  },
  {
    ...
    content: "There’s no time for questions. Choose. Save yourself, or save the innocent lives of the other campers",
    choices: [
      {
        text: "...how?",
        target: 38,
